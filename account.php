...
<h2>My Account</h2>
  ...
  <div id="CurrentPurchases" class="tabcontent">
    <?php
      require_once('config.php');
      $sql = "SELECT * FROM Reservation, (SELECT CURDATE()) AS Today WHERE AccountNumber = '{$_SESSION['account_Num']}' AND DateOfShowing >= CURDATE() ORDER BY DateOfShowing";
             ...
             <tr>
                ...
                <tr>
                   ...
                   <form action="cancelpurchase.php" method="post" >
                     <td><button class="btn" onclick="" name="cancelPurchase" value="<?php echo $row['ID']  ?>">Cancel Purchase</button></td>
                   </form>
                 </tr>
                   <?php
                    }
